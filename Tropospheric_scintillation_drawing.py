...
def drawing(A_241_list, A_242_list, A_243_list, x):
    ...
    plt.plot(x, A_243_list, color='b', linestyle='-', linewidth='0.7', label='2.4.3')
    plt.legend()
    plt.show()
...
if __name__ == '__main__':
    ...
    A_242_list = []
    A_243_list = []
    ax_x = np.arange(0.5, 5.1, 0.1)  # 角度范围
    for degree in ax_x:
    ...
    drawing(A_241_list, A_242_list, A_243_list, ax_x)
